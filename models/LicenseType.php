...
/**
 * Table class for license_type
 */
class LicenseType extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'license_type';
        $this->TableName = 'license_type';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`license_type`";
        $this->Dbid = 'DB';
        ...
        $this->modifyWhen->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->modifyWhen->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en-US":
                $this->modifyWhen->Lookup = new Lookup('modifyWhen', 'core_users', false, 'id', ["nickname","","",""], [], [], [], [], [], [], '', '', "`nickname`");
                break;
            default:
                $this->modifyWhen->Lookup = new Lookup('modifyWhen', 'core_users', false, 'id', ["nickname","","",""], [], [], [], [], [], [], '', '', "`nickname`");
                break;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`license_type`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("LicenseTypeList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "LicenseTypeEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "LicenseTypeAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "LicenseTypeAdd";
            case Config("API_EDIT_ACTION"):
                return "LicenseTypeEdit";
            case Config("API_DELETE_ACTION"):
                return "LicenseTypeDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("LicenseTypeView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("LicenseTypeView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "LicenseTypeAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "LicenseTypeAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("LicenseTypeEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("LicenseTypeAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("LicenseTypeDelete", $this->getUrlParm());
    }
