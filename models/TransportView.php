 ...
 * Page class
 */
class TransportView extends Transport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransportView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "TransportList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "TransportList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "TransportList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
