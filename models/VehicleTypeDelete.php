 ...
 * Page class
 */
class VehicleTypeDelete extends VehicleType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VehicleTypeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("VehicleTypeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("VehicleTypeList"); // Return to list
                return;
            }
        }
