 ...
 * Page class
 */
class CoreStatusAdd extends CoreStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreStatusAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("CoreStatusList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "CoreStatusList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "CoreStatusView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->insertUserID->DefaultValue = 0;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        $this->insertUserID->setDbValueDef($rsnew, $this->insertUserID->CurrentValue, 0);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("CoreStatusList"), "", $this->TableVar, true);
