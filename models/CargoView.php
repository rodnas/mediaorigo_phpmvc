    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "CargoList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "CargoList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "CargoList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
