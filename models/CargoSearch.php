...
class CargoSearch extends Cargo
{
    ...
    // Page object name
    public $PageObjName = "CargoSearch";
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->place); // place
        $this->buildSearchUrl($srchUrl, $this->cargo_weight); // cargo_weight
