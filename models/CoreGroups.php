...
/**
 * Table class for core_groups
 */
class CoreGroups extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'core_groups';
        $this->TableName = 'core_groups';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`core_groups`";
        $this->Dbid = 'DB';
        ...
        $this->insertUserID->Required = true; // Required field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`core_groups`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("CoreGroupsList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "CoreGroupsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "CoreGroupsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "CoreGroupsView";
            case Config("API_ADD_ACTION"):
                return "CoreGroupsAdd";
            case Config("API_EDIT_ACTION"):
                return "CoreGroupsEdit";
            case Config("API_DELETE_ACTION"):
                return "CoreGroupsDelete";
            case Config("API_LIST_ACTION"):
                return "CoreGroupsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CoreGroupsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("CoreGroupsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "CoreGroupsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "CoreGroupsAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("CoreGroupsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CoreGroupsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("CoreGroupsDelete", $this->getUrlParm());
    }
