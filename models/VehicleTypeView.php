 ...
 * Page class
 */
class VehicleTypeView extends VehicleType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VehicleTypeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "VehicleTypeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("VehicleTypeList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "VehicleTypeList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "VehicleTypeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VehicleTypeList"), "", $this->TableVar, true);
        $pageId = "view";
