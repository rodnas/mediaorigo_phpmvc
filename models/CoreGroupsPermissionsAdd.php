 ...
 * Page class
 */
class CoreGroupsPermissionsAdd extends CoreGroupsPermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreGroupsPermissionsAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CoreGroupsPermissionsView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // core_groupsID
        $this->core_groupsID->setDbValueDef($rsnew, $this->core_groupsID->CurrentValue, 0, false);
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['core_groupsID']) == "") {
