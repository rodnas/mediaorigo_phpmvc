 ...
 * Page class
 */
class CoreUsersView extends CoreUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreUsersView";
    ...
    public function run()
    {
        ...
        $this->lastLoginWhen->setVisibility();
        $this->activationCode->setVisibility();
        $this->regmailWhen->setVisibility();
        $this->activationWhen->setVisibility();
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "CoreUsersList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("CoreUsersList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "CoreUsersList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "CoreUsersList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
