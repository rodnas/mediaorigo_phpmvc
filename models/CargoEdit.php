...
class CargoEdit extends Cargo
{
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("CargoList"); // Return to list page
                        return;
    ...
    protected function editRow()
    {
        ...
        // place
        $this->place->setDbValueDef($rsnew, $this->place->CurrentValue, "", $this->place->ReadOnly);

        // cargo_weight
        $this->cargo_weight->setDbValueDef($rsnew, $this->cargo_weight->CurrentValue, null, $this->cargo_weight->ReadOnly);
