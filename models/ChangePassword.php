 ...
 * Page class
 */
class ChangePassword extends CoreUsers
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        $this->OldPassword = new DbField("core_users", "core_users", "opwd", "opwd", "opwd", "", 202, 255, -1, false, "", false, false, false);
        $this->OldPassword->EditAttrs->appendClass("form-control ew-form-control");
        $this->NewPassword = new DbField("core_users", "core_users", "npwd", "npwd", "npwd", "", 202, 255, -1, false, "", false, false, false);
        $this->NewPassword->EditAttrs->appendClass("form-control ew-form-control");
        $this->ConfirmPassword = new DbField("core_users", "core_users", "cpwd", "cpwd", "cpwd", "", 202, 255, -1, false, "", false, false, false);
