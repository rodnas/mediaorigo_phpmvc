 ...
 * Page class
 */
class CoreUsersDelete extends CoreUsers
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreUsersDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CoreUsersList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if (!$res) {
            $this->terminate("CoreUsersList"); // Return to list
            return;
        }
