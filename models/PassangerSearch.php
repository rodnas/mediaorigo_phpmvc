...
class PassangerSearch extends Passanger
{
    ...
    // Page object name
    public $PageObjName = "PassangerSearch";
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->customer_name); // customer_name
        $this->buildSearchUrl($srchUrl, $this->how_many_people); // how_many_people
        $this->buildSearchUrl($srchUrl, $this->transport_date); // transport_date
    ...
    protected function loadSearchValues()
    {
        ...
        // customer_name
        if ($this->customer_name->AdvancedSearch->get()) {
            $hasValue = true;
        }

        // how_many_people
        if ($this->how_many_people->AdvancedSearch->get()) {
            $hasValue = true;
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->how_many_people->EditValue = HtmlEncode($this->how_many_people->AdvancedSearch->SearchValue);
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->how_many_people->AdvancedSearch->SearchValue)) {
    ...
    public function loadAdvancedSearch()
    {
        ...
        $this->how_many_people->AdvancedSearch->load();
