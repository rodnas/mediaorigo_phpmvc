 ...
 * Page class
 */
class CoreLanguageAdd extends CoreLanguage
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreLanguageAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "CoreLanguageView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->imageURL->Visible && !$this->imageURL->Upload->KeepFile) {
            $this->imageURL->Upload->DbValue = ""; // No need to delete old file
        ...
        if ($this->imageURL->Visible && !$this->imageURL->Upload->KeepFile) {
            ...
            if (!EmptyValue($this->imageURL->Upload->FileName)) {
                ...
                $this->imageURL->setDbValueDef($rsnew, $this->imageURL->Upload->FileName, null, false);
            }
        }
