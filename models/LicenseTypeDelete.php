 ...
 * Page class
 */
class LicenseTypeDelete extends LicenseType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LicenseTypeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LicenseTypeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LicenseTypeList"); // Return to list
                return;
            }
        }
