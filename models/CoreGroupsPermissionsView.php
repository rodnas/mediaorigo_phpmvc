 ...
 * Page class
 */
class CoreGroupsPermissionsView extends CoreGroupsPermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreGroupsPermissionsView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("core_groupsID") ?? Route("core_groupsID")) !== null) {
            $this->RecKey["core_groupsID"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("core_groupsID") ?? Route("core_groupsID")) !== null) {
                ...
                $this->RecKey["core_groupsID"] = $this->core_groupsID->QueryStringValue;
            } elseif (Post("core_groupsID") !== null) {
                $this->core_groupsID->setFormValue(Post("core_groupsID"));
                $this->RecKey["core_groupsID"] = $this->core_groupsID->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->core_groupsID->setQueryStringValue($keyValue);
                $this->RecKey["core_groupsID"] = $this->core_groupsID->QueryStringValue;
            } elseif (!$loadCurrentRecord) {
                $returnUrl = "CoreGroupsPermissionsList"; // Return to list
            }
            if (($keyValue = Get("_tablename") ?? Route("_tablename")) !== null) {
                    ...
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            while (!$this->Recordset->EOF) {
                                if (SameString($this->core_groupsID->CurrentValue, $this->Recordset->fields['core_groupsID']) && SameString($this->_tablename->CurrentValue, $this->Recordset->fields['tablename'])) {
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "CoreGroupsPermissionsList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "CoreGroupsPermissionsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
