...
/**
 * Table class for vehicle_type
 */
class VehicleType extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'vehicle_type';
        $this->TableName = 'vehicle_type';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`vehicle_type`";
        $this->Dbid = 'DB';
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`vehicle_type`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VehicleTypeList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "VehicleTypeEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VehicleTypeAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VehicleTypeView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VehicleTypeView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VehicleTypeAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VehicleTypeAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("VehicleTypeEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VehicleTypeAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VehicleTypeDelete", $this->getUrlParm());
    }
