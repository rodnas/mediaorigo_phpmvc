 ...
 * Page class
 */
class DriverAdd extends Driver
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "DriverView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // birth_year
        $this->birth_year->setDbValueDef($rsnew, $this->birth_year->CurrentValue, null, false);

        // license_typeID
        $this->license_typeID->setDbValueDef($rsnew, $this->license_typeID->CurrentValue, 0, false);
