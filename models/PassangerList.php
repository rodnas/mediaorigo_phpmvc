 ...
 * Page class
 */
class PassangerList extends Passanger
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PassangerList";
    ...
    public $FormName = "fpassangerlist";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "PassangerAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "PassangerDelete";
        $this->MultiUpdateUrl = "PassangerUpdate";
    ...
    public function getFilterList()
    {
        ...
        $filterList = Concat($filterList, $this->how_many_people->AdvancedSearch->toJson(), ","); // Field how_many_people
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fpassangersrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field how_many_people
        $this->how_many_people->AdvancedSearch->SearchValue = @$filter["x_how_many_people"];
        $this->how_many_people->AdvancedSearch->SearchOperator = @$filter["z_how_many_people"];
        $this->how_many_people->AdvancedSearch->SearchCondition = @$filter["v_how_many_people"];
        $this->how_many_people->AdvancedSearch->SearchValue2 = @$filter["y_how_many_people"];
        $this->how_many_people->AdvancedSearch->SearchOperator2 = @$filter["w_how_many_people"];
        $this->how_many_people->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->how_many_people, $default, false); // how_many_people
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->how_many_people->AdvancedSearch->save(); // how_many_people
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        $searchFlds = [];
        $searchFlds[] = &$this->id;
        $searchFlds[] = &$this->customer_name;
        $searchFlds[] = &$this->how_many_people;
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->how_many_people->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
        ...
        $this->how_many_people->AdvancedSearch->unsetSession();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->how_many_people); // how_many_people
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpassangerlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fpassangerlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("customer_name", $this->createColumnOption("customer_name"));
            $option->add("how_many_people", $this->createColumnOption("how_many_people"));
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fpassangersrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fpassangersrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fpassangerlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->how_many_people->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->how_many_people->AdvancedSearch->SearchValue != "" || $this->how_many_people->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fpassangersrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch") . "\" data-caption=\"" . $Language->phrase("AdvancedSearch") . "\" href=\"PassangerSearch\">" . $Language->phrase("AdvancedSearchBtn") . "</a>";
        $item->Visible = true;
