 ...
 */
class Transport extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->vehicleID->InputTextType = "text";
        $this->vehicleID->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->vehicleID->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en-US":
                $this->vehicleID->Lookup = new Lookup('vehicleID', 'vehicle', false, 'id', ["lpn","start_year","person","max_weight"], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`lpn`, ''),'" . ValueSeparator(1, $this->vehicleID) . "',COALESCE(`start_year`,''),'" . ValueSeparator(2, $this->vehicleID) . "',COALESCE(`person`,''),'" . ValueSeparator(3, $this->vehicleID) . "',COALESCE(`max_weight`,''))");
                break;
            default:
                $this->vehicleID->Lookup = new Lookup('vehicleID', 'vehicle', false, 'id', ["lpn","start_year","person","max_weight"], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`lpn`, ''),'" . ValueSeparator(1, $this->vehicleID) . "',COALESCE(`start_year`,''),'" . ValueSeparator(2, $this->vehicleID) . "',COALESCE(`person`,''),'" . ValueSeparator(3, $this->vehicleID) . "',COALESCE(`max_weight`,''))");
                break;
        }
        $this->vehicleID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['vehicleID'] = &$this->vehicleID;

        // driverID
        $this->driverID = new DbField(
            'transport',
            'transport',
            'x_driverID',
            'driverID',
        ...
        $this->driverID->InputTextType = "text";
        $this->driverID->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->driverID->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en-US":
                $this->driverID->Lookup = new Lookup('driverID', 'driver', false, 'id', ["name","birth_year","license_typeID",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`name`, ''),'" . ValueSeparator(1, $this->driverID) . "',COALESCE(`birth_year`,''),'" . ValueSeparator(2, $this->driverID) . "',COALESCE(`license_typeID`,''))");
                break;
            default:
                $this->driverID->Lookup = new Lookup('driverID', 'driver', false, 'id', ["name","birth_year","license_typeID",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`name`, ''),'" . ValueSeparator(1, $this->driverID) . "',COALESCE(`birth_year`,''),'" . ValueSeparator(2, $this->driverID) . "',COALESCE(`license_typeID`,''))");
                break;
        }
        $this->driverID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['driverID'] = &$this->driverID;

        // cargoID
        $this->cargoID = new DbField(
            'transport',
            'transport',
            'x_cargoID',
            'cargoID',
        ...
        $this->cargoID->InputTextType = "text";
        $this->cargoID->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->cargoID->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en-US":
                $this->cargoID->Lookup = new Lookup('cargoID', 'cargo', false, 'id', ["place","","",""], [], [], [], [], [], [], '', '', "`place`");
                break;
            default:
                $this->cargoID->Lookup = new Lookup('cargoID', 'cargo', false, 'id', ["place","","",""], [], [], [], [], [], [], '', '', "`place`");
                break;
        }
        $this->cargoID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['cargoID'] = &$this->cargoID;

        // passangerID
        $this->passangerID = new DbField(
            'transport',
            'transport',
            'x_passangerID',
            'passangerID',
        ...
        $this->passangerID->InputTextType = "text";
        $this->passangerID->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->passangerID->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en-US":
                $this->passangerID->Lookup = new Lookup('passangerID', 'passanger', false, 'id', ["customer_name","how_many_people","transport_date",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`customer_name`, ''),'" . ValueSeparator(1, $this->passangerID) . "',COALESCE(`how_many_people`,''),'" . ValueSeparator(2, $this->passangerID) . "',COALESCE(" . CastDateFieldForLike("`transport_date`", "y-MM-dd", "DB") . ",''))");
                break;
            default:
                $this->passangerID->Lookup = new Lookup('passangerID', 'passanger', false, 'id', ["customer_name","how_many_people","transport_date",""], [], [], [], [], [], [], '', '', "CONCAT(COALESCE(`customer_name`, ''),'" . ValueSeparator(1, $this->passangerID) . "',COALESCE(`how_many_people`,''),'" . ValueSeparator(2, $this->passangerID) . "',COALESCE(" . CastDateFieldForLike("`transport_date`", "y-MM-dd", "DB") . ",''))");
                break;
        }
        $this->passangerID->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['passangerID'] = &$this->passangerID;
        ...
        $this->order_date = new DbField(
            ...
            'order_date',
            '`order_date`',
            CastDateFieldForLike("`order_date`", "y-MM-dd", "DB"),
            133,
            10,
            0,
            false,
        ...
        $this->order_date->FormatPattern = "y-MM-dd"; // Format pattern
        $this->order_date->DefaultErrorMessage = str_replace("%s", "y-MM-dd", $Language->phrase("IncorrectDate"));
        ...
        $this->core_languageID->Nullable = false; // NOT NULL field
        $this->core_languageID->Required = true; // Required field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`transport`";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->driverID->DbValue = $row['driverID'];
        $this->cargoID->DbValue = $row['cargoID'];
        $this->passangerID->DbValue = $row['passangerID'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TransportList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "TransportEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TransportAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TransportView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TransportView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TransportAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TransportAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TransportEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TransportAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TransportDelete", $this->getUrlParm());
    }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->vehicleID);
                    $doc->exportCaption($this->driverID);
                    $doc->exportCaption($this->cargoID);
                    $doc->exportCaption($this->passangerID);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->vehicleID);
                        $doc->exportField($this->driverID);
                        $doc->exportField($this->cargoID);
                        $doc->exportField($this->passangerID);
