 ...
 * Page class
 */
class CoreLanguageView extends CoreLanguage
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreLanguageView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "CoreLanguageList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "CoreLanguageList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "CoreLanguageList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
