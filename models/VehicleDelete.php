 ...
 * Page class
 */
class VehicleDelete extends Vehicle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VehicleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("VehicleList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("VehicleList"); // Return to list
                return;
            }
        }
