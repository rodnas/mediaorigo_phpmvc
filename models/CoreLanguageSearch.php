 ...
 * Page class
 */
class CoreLanguageSearch extends CoreLanguage
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreLanguageSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "CoreLanguageList" . "?" . $srchStr;
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->imageURL); // imageURL
    ...
    protected function loadSearchValues()
    {
        ...
        // imageURL
        if ($this->imageURL->AdvancedSearch->get()) {
            $hasValue = true;
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (!$this->imageURL->Raw) {
                $this->imageURL->AdvancedSearch->SearchValue = HtmlDecode($this->imageURL->AdvancedSearch->SearchValue);
            }
            $this->imageURL->EditValue = HtmlEncode($this->imageURL->AdvancedSearch->SearchValue);
            $this->imageURL->PlaceHolder = RemoveHtml($this->imageURL->caption());
    ...
    public function loadAdvancedSearch()
    {
        ...
        $this->imageURL->AdvancedSearch->load();
