 ...
 * Page class
 */
class CoreGroupsView extends CoreGroups
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreGroupsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "CoreGroupsList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("CoreGroupsList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "CoreGroupsList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "CoreGroupsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
