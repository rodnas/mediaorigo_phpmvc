 ...
 * Page class
 */
class CargoDelete extends Cargo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CargoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CargoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CargoList"); // Return to list
                return;
            }
        }
