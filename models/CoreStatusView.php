 ...
 * Page class
 */
class CoreStatusView extends CoreStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreStatusView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "CoreStatusList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("CoreStatusList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "CoreStatusList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "CoreStatusList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
