...
class DriverSearch extends Driver
{
    ...
    // Page object name
    public $PageObjName = "DriverSearch";
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->birth_year); // birth_year
        $this->buildSearchUrl($srchUrl, $this->license_typeID); // license_typeID
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->modifyUserID->AdvancedSearch->ViewValue !== null) { // Load from cache
                ...
                foreach ($arwrk as &$row) {
                    $row = $this->modifyUserID->Lookup->renderViewRow($row);
                }
