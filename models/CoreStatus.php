...
/**
 * Table class for core_status
 */
class CoreStatus extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'core_status';
        $this->TableName = 'core_status';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "`core_status`";
        $this->Dbid = 'DB';
        ...
        $this->insertUserID->Nullable = false; // NOT NULL field
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "`core_status`";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("CoreStatusList");
    }
    ...
    {
        global $Language;
        if ($pageName == "CoreStatusView") {
            return $Language->phrase("View");
        } elseif ($pageName == "CoreStatusEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "CoreStatusAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "CoreStatusView";
            case Config("API_ADD_ACTION"):
                return "CoreStatusAdd";
            case Config("API_EDIT_ACTION"):
                return "CoreStatusEdit";
            case Config("API_DELETE_ACTION"):
                return "CoreStatusDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("CoreStatusView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("CoreStatusView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "CoreStatusAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "CoreStatusAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("CoreStatusEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("CoreStatusAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("CoreStatusDelete", $this->getUrlParm());
    }
