 ...
 * Page class
 */
class PassangerView extends Passanger
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PassangerView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PassangerList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "PassangerList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "PassangerList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
