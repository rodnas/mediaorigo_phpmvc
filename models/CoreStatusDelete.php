 ...
 * Page class
 */
class CoreStatusDelete extends CoreStatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreStatusDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CoreStatusList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CoreStatusList"); // Return to list
                return;
            }
        }
