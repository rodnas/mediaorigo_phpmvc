 ...
 * Page class
 */
class CoreGroupsPermissionsDelete extends CoreGroupsPermissions
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreGroupsPermissionsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CoreGroupsPermissionsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CoreGroupsPermissionsList"); // Return to list
                return;
            }
        }
