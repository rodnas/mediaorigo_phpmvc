 ...
 * Page class
 */
class PassangerAdd extends Passanger
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PassangerAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PassangerView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // how_many_people
        $this->how_many_people->setDbValueDef($rsnew, $this->how_many_people->CurrentValue, null, false);
