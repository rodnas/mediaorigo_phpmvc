 ...
 * Page class
 */
class TransportEdit extends Transport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransportEdit";
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("TransportList"); // Return to list page
                        return;
    ...
    protected function editRow()
    {
        ...
        // driverID
        $this->driverID->setDbValueDef($rsnew, $this->driverID->CurrentValue, null, $this->driverID->ReadOnly);

        // cargoID
        $this->cargoID->setDbValueDef($rsnew, $this->cargoID->CurrentValue, null, $this->cargoID->ReadOnly);

        // passangerID
        $this->passangerID->setDbValueDef($rsnew, $this->passangerID->CurrentValue, null, $this->passangerID->ReadOnly);

        // order_date
        $this->order_date->setDbValueDef($rsnew, UnFormatDateTime($this->order_date->CurrentValue, $this->order_date->formatPattern()), null, $this->order_date->ReadOnly);
        ...
        // core_languageID
        $this->core_languageID->setDbValueDef($rsnew, $this->core_languageID->CurrentValue, "", $this->core_languageID->ReadOnly);
