 ...
 * Page class
 */
class DriverDelete extends Driver
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DriverDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DriverList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DriverList"); // Return to list
                return;
            }
        }
