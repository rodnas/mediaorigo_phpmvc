 ...
 * Page class
 */
class LicenseTypeView extends LicenseType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LicenseTypeView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "LicenseTypeList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if ($this->TotalRecords <= 0) { // No record found
                            ...
                            $this->terminate("LicenseTypeList"); // Return to list page
                            return;
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "LicenseTypeList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "LicenseTypeList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
