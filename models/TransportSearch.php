...
class TransportSearch extends Transport
{
    ...
    // Page object name
    public $PageObjName = "TransportSearch";
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->vehicleID); // vehicleID
        $this->buildSearchUrl($srchUrl, $this->driverID); // driverID
        $this->buildSearchUrl($srchUrl, $this->cargoID); // cargoID
        $this->buildSearchUrl($srchUrl, $this->passangerID); // passangerID
