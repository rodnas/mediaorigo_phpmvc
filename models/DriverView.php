 ...
 * Page class
 */
class DriverView extends Driver
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "DriverList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "DriverList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "DriverList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
