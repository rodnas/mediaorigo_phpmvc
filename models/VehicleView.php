...
class VehicleView extends Vehicle
{
    ...
    // Page object name
    public $PageObjName = "VehicleView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            ...
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "VehicleList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                    if (!$this->IsModal) { // Normal view page
                        ...
                        if (!$matchRecord) {
                            ...
                            $returnUrl = "VehicleList"; // No matching record, return to list
                        } else {
            ...
            $returnUrl = "VehicleList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
