 ...
 * Page class
 */
class TransportDelete extends Transport
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TransportDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TransportList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TransportList"); // Return to list
                return;
            }
        }
