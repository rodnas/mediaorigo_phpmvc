 ...
 * Page class
 */
class PassangerDelete extends Passanger
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PassangerDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PassangerList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PassangerList"); // Return to list
                return;
            }
        }
