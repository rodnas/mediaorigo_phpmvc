 ...
 * Page class
 */
class CoreGroupsDelete extends CoreGroups
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CoreGroupsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("CoreGroupsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("CoreGroupsList"); // Return to list
                return;
            }
        }
