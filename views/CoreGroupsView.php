...
var fcore_groupsview;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fcore_groupsview = new ew.Form("fcore_groupsview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fcore_groupsview;
    loadjs.done("fcore_groupsview");
});
</script>
<script>
...
<?php } ?>
<?php } ?>
<form name="fcore_groupsview" id="fcore_groupsview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
