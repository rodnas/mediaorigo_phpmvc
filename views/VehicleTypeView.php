...
var fvehicle_typeview;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fvehicle_typeview = new ew.Form("fvehicle_typeview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fvehicle_typeview;
    loadjs.done("fvehicle_typeview");
});
</script>
<script>
...
<?php } ?>
<?php } ?>
<form name="fvehicle_typeview" id="fvehicle_typeview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_vehicle_type_insertUserID">
...
<span id="el_vehicle_type_insertWhen">
...
<span id="el_vehicle_type_modifyUserID">
...
<span id="el_vehicle_type_modifyWhen">
