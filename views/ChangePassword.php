...
<?php } ?>
    <div class="row gx-0">
        <div class="input-group px-0">
            ...
            <button type="button" class="btn btn-default ew-password-generator rounded-end" title="<?= HtmlTitle($Language->phrase("GeneratePassword")) ?>" data-password-field="<?= $Page->NewPassword->FieldVar ?>" data-password-confirm="<?= $Page->ConfirmPassword->FieldVar ?>"><?= $Language->phrase("GeneratePassword") ?></button>
        </div>
