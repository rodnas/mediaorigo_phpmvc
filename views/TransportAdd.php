...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    ftransportadd = new ew.Form("ftransportadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = ftransportadd;

    // Add fields
    var fields = currentTable.fields;
    ftransportadd.addFields([
    ...
    // Form_CustomValidate
    ftransportadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftransportadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    ftransportadd.lists.vehicleID = <?= $Page->vehicleID->toClientList($Page) ?>;
    ftransportadd.lists.driverID = <?= $Page->driverID->toClientList($Page) ?>;
    ftransportadd.lists.cargoID = <?= $Page->cargoID->toClientList($Page) ?>;
    ftransportadd.lists.passangerID = <?= $Page->passangerID->toClientList($Page) ?>;
    ftransportadd.lists.insertUserID = <?= $Page->insertUserID->toClientList($Page) ?>;
    ftransportadd.lists.core_statusID = <?= $Page->core_statusID->toClientList($Page) ?>;
    ftransportadd.lists.core_languageID = <?= $Page->core_languageID->toClientList($Page) ?>;
    loadjs.done("ftransportadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="ftransportadd" id="ftransportadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } else { ?>
<table id="tbl_transportadd" class="table table-striped table-bordered table-hover table-sm ew-desktop-table"><!-- table* -->
<?php } ?>
...
<span id="el_transport_vehicleID">
    <select
        ...
        data-select2-id="ftransportadd_x_vehicleID"
...
<script>
loadjs.ready("ftransportadd", function() {
    var options = { name: "x_vehicleID", selectId: "ftransportadd_x_vehicleID" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftransportadd.lists.vehicleID.lookupOptions.length) {
        options.data = { id: "x_vehicleID", form: "ftransportadd" };
    } else {
        options.ajax = { id: "x_vehicleID", form: "ftransportadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_transport_driverID">
    <select
        ...
        data-select2-id="ftransportadd_x_driverID"
        data-table="transport"
...
<script>
loadjs.ready("ftransportadd", function() {
    var options = { name: "x_driverID", selectId: "ftransportadd_x_driverID" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftransportadd.lists.driverID.lookupOptions.length) {
        options.data = { id: "x_driverID", form: "ftransportadd" };
    } else {
        options.ajax = { id: "x_driverID", form: "ftransportadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_transport_cargoID">
    <select
        ...
        data-select2-id="ftransportadd_x_cargoID"
        data-table="transport"
...
<script>
loadjs.ready("ftransportadd", function() {
    var options = { name: "x_cargoID", selectId: "ftransportadd_x_cargoID" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftransportadd.lists.cargoID.lookupOptions.length) {
        options.data = { id: "x_cargoID", form: "ftransportadd" };
    } else {
        options.ajax = { id: "x_cargoID", form: "ftransportadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_transport_passangerID">
    <select
        ...
        data-select2-id="ftransportadd_x_passangerID"
        data-table="transport"
...
<script>
loadjs.ready("ftransportadd", function() {
    var options = { name: "x_passangerID", selectId: "ftransportadd_x_passangerID" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftransportadd.lists.passangerID.lookupOptions.length) {
        options.data = { id: "x_passangerID", form: "ftransportadd" };
    } else {
        options.ajax = { id: "x_passangerID", form: "ftransportadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<script>
loadjs.ready(["ftransportadd", "datetimepicker"], function () {
    let format = "<?= "y-MM-dd" ?>",
        options = {
            localization: {
    ...
    ew.createDateTimePicker("ftransportadd", "x_order_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_transport_core_statusID">
    <select
        ...
        data-select2-id="ftransportadd_x_core_statusID"
        data-table="transport"
...
<script>
loadjs.ready("ftransportadd", function() {
    var options = { name: "x_core_statusID", selectId: "ftransportadd_x_core_statusID" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftransportadd.lists.core_statusID.lookupOptions.length) {
        options.data = { id: "x_core_statusID", form: "ftransportadd" };
    } else {
        options.ajax = { id: "x_core_statusID", form: "ftransportadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_transport_core_languageID">
    <select
        ...
        data-select2-id="ftransportadd_x_core_languageID"
        data-table="transport"
...
<script>
loadjs.ready("ftransportadd", function() {
    var options = { name: "x_core_languageID", selectId: "ftransportadd_x_core_languageID" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftransportadd.lists.core_languageID.lookupOptions.length) {
        options.data = { id: "x_core_languageID", form: "ftransportadd" };
    } else {
        options.ajax = { id: "x_core_languageID", form: "ftransportadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
