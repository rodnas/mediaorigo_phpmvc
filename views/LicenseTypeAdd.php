...
var flicense_typeadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    flicense_typeadd = new ew.Form("flicense_typeadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = flicense_typeadd;

    // Add fields
    var fields = currentTable.fields;
    flicense_typeadd.addFields([
    ...
    // Form_CustomValidate
    flicense_typeadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    flicense_typeadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    flicense_typeadd.lists.insertUserID = <?= $Page->insertUserID->toClientList($Page) ?>;
    flicense_typeadd.lists.core_statusID = <?= $Page->core_statusID->toClientList($Page) ?>;
    loadjs.done("flicense_typeadd");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="flicense_typeadd" id="flicense_typeadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } else { ?>
<table id="tbl_license_typeadd" class="table table-striped table-bordered table-hover table-sm ew-desktop-table"><!-- table* -->
<?php } ?>
...
<span id="el_license_type_core_statusID">
    <select
        ...
        data-select2-id="flicense_typeadd_x_core_statusID"
...
<script>
loadjs.ready("flicense_typeadd", function() {
    var options = { name: "x_core_statusID", selectId: "flicense_typeadd_x_core_statusID" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (flicense_typeadd.lists.core_statusID.lookupOptions.length) {
        options.data = { id: "x_core_statusID", form: "flicense_typeadd" };
    } else {
        options.ajax = { id: "x_core_statusID", form: "flicense_typeadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
