...
var fcargosearch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object for search
    fcargosearch = new ew.Form("fcargosearch", "search");
    <?php if ($Page->IsModal) { ?>
    currentAdvancedSearchForm = fcargosearch;
    <?php } else { ?>
    currentForm = fcargosearch;
    <?php } ?>
    currentPageID = ew.PAGE_ID = "search";

    // Add fields
    var fields = currentTable.fields;
    fcargosearch.addFields([
    ...
    // Validate form
    fcargosearch.validate = function () {
    ...
    // Form_CustomValidate
    fcargosearch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fcargosearch.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fcargosearch.lists.insertUserID = <?= $Page->insertUserID->toClientList($Page) ?>;
    fcargosearch.lists.modifyUserID = <?= $Page->modifyUserID->toClientList($Page) ?>;
    fcargosearch.lists.core_statusID = <?= $Page->core_statusID->toClientList($Page) ?>;
    fcargosearch.lists.core_languageID = <?= $Page->core_languageID->toClientList($Page) ?>;
    loadjs.done("fcargosearch");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="fcargosearch" id="fcargosearch" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } else { ?>
<table id="tbl_cargosearch" class="table table-striped table-bordered table-hover table-sm ew-desktop-table"><!-- table* -->
<?php } ?>
<?php if ($Page->id->Visible) { // id ?>
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_id"<?= $Page->id->rowAttributes() ?>>
        <label for="x_id" class="<?= $Page->LeftColumnClass ?>"><span id="elh_cargo_id"><?= $Page->id->caption() ?></span>
...
<input type="hidden" name="z_id" id="z_id" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            ...
            <span id="el_cargo_id" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->id->getInputTextType() ?>" name="x_id" id="x_id" data-table="cargo" data-field="x_id" value="<?= $Page->id->EditValue ?>" placeholder="<?= HtmlEncode($Page->id->getPlaceHolder()) ?>"<?= $Page->id->editAttributes() ?>>
...
<input type="hidden" name="z_id" id="z_id" value="=">
        ...
        <td<?= $Page->id->cellAttributes() ?>>
            <div class="text-nowrap">
                <span id="el_cargo_id" class="ew-search-field">
<input type="<?= $Page->id->getInputTextType() ?>" name="x_id" id="x_id" data-table="cargo" data-field="x_id" value="<?= $Page->id->EditValue ?>" placeholder="<?= HtmlEncode($Page->id->getPlaceHolder()) ?>"<?= $Page->id->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->id->getErrorMessage(false) ?></div>
</span>
            </div>
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_place"<?= $Page->place->rowAttributes() ?>>
        <label for="x_place" class="<?= $Page->LeftColumnClass ?>"><span id="elh_cargo_place"><?= $Page->place->caption() ?></span>
        <span class="ew-search-operator">
...
<input type="hidden" name="z_place" id="z_place" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->place->cellAttributes() ?>>
            <span id="el_cargo_place" class="ew-search-field ew-search-field-single">
...
<input type="hidden" name="z_place" id="z_place" value="LIKE">
        ...
        <td<?= $Page->place->cellAttributes() ?>>
            <div class="text-nowrap">
                <span id="el_cargo_place" class="ew-search-field">
<input type="<?= $Page->place->getInputTextType() ?>" name="x_place" id="x_place" data-table="cargo" data-field="x_place" value="<?= $Page->place->EditValue ?>" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->place->getPlaceHolder()) ?>"<?= $Page->place->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->place->getErrorMessage(false) ?></div>
</span>
            </div>
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_cargo_weight"<?= $Page->cargo_weight->rowAttributes() ?>>
        <label for="x_cargo_weight" class="<?= $Page->LeftColumnClass ?>"><span id="elh_cargo_cargo_weight"><?= $Page->cargo_weight->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_cargo_weight" id="z_cargo_weight" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->cargo_weight->cellAttributes() ?>>
            <span id="el_cargo_cargo_weight" class="ew-search-field ew-search-field-single">
...
<input type="hidden" name="z_cargo_weight" id="z_cargo_weight" value="=">
        ...
        <td<?= $Page->cargo_weight->cellAttributes() ?>>
            <div class="text-nowrap">
                <span id="el_cargo_cargo_weight" class="ew-search-field">
<input type="<?= $Page->cargo_weight->getInputTextType() ?>" name="x_cargo_weight" id="x_cargo_weight" data-table="cargo" data-field="x_cargo_weight" value="<?= $Page->cargo_weight->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->cargo_weight->getPlaceHolder()) ?>"<?= $Page->cargo_weight->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->cargo_weight->getErrorMessage(false) ?></div>
</span>
            </div>
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_transport_date"<?= $Page->transport_date->rowAttributes() ?>>
        <label for="x_transport_date" class="<?= $Page->LeftColumnClass ?>"><span id="elh_cargo_transport_date"><?= $Page->transport_date->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_transport_date" id="z_transport_date" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            ...
            <span id="el_cargo_transport_date" class="ew-search-field ew-search-field-single">
...
<script>
loadjs.ready(["fcargosearch", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcargosearch", "x_transport_date", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<input type="hidden" name="z_transport_date" id="z_transport_date" value="=">
        ...
        <td<?= $Page->transport_date->cellAttributes() ?>>
            <div class="text-nowrap">
                <span id="el_cargo_transport_date" class="ew-search-field">
<input type="<?= $Page->transport_date->getInputTextType() ?>" name="x_transport_date" id="x_transport_date" data-table="cargo" data-field="x_transport_date" value="<?= $Page->transport_date->EditValue ?>" placeholder="<?= HtmlEncode($Page->transport_date->getPlaceHolder()) ?>"<?= $Page->transport_date->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->transport_date->getErrorMessage(false) ?></div>
<?php if (!$Page->transport_date->ReadOnly && !$Page->transport_date->Disabled && !isset($Page->transport_date->EditAttrs["readonly"]) && !isset($Page->transport_date->EditAttrs["disabled"])) { ?>
<script>
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_insertUserID"<?= $Page->insertUserID->rowAttributes() ?>>
        <label for="x_insertUserID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_cargo_insertUserID"><?= $Page->insertUserID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_insertUserID" id="z_insertUserID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            ...
            <span id="el_cargo_insertUserID" class="ew-search-field ew-search-field-single">
    <select
        id="x_insertUserID"
        name="x_insertUserID"
        class="form-select ew-select<?= $Page->insertUserID->isInvalidClass() ?>"
        data-select2-id="fcargosearch_x_insertUserID"
        data-table="cargo"
...
<script>
loadjs.ready("fcargosearch", function() {
    var options = { name: "x_insertUserID", selectId: "fcargosearch_x_insertUserID" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcargosearch.lists.insertUserID.lookupOptions.length) {
        options.data = { id: "x_insertUserID", form: "fcargosearch" };
    } else {
        options.ajax = { id: "x_insertUserID", form: "fcargosearch", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
    options = Object.assign({}, ew.selectOptions, options, ew.vars.tables.cargo.fields.insertUserID.selectOptions);
...
<input type="hidden" name="z_insertUserID" id="z_insertUserID" value="=">
        ...
        <td<?= $Page->insertUserID->cellAttributes() ?>>
            <div class="text-nowrap">
                <span id="el_cargo_insertUserID" class="ew-search-field">
    <select
        id="x_insertUserID"
        name="x_insertUserID"
        class="form-select ew-select<?= $Page->insertUserID->isInvalidClass() ?>"
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_insertWhen"<?= $Page->insertWhen->rowAttributes() ?>>
        <label for="x_insertWhen" class="<?= $Page->LeftColumnClass ?>"><span id="elh_cargo_insertWhen"><?= $Page->insertWhen->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_insertWhen" id="z_insertWhen" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            ...
            <span id="el_cargo_insertWhen" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->insertWhen->getInputTextType() ?>" name="x_insertWhen" id="x_insertWhen" data-table="cargo" data-field="x_insertWhen" value="<?= $Page->insertWhen->EditValue ?>" placeholder="<?= HtmlEncode($Page->insertWhen->getPlaceHolder()) ?>"<?= $Page->insertWhen->editAttributes() ?>>
...
loadjs.ready(["fcargosearch", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcargosearch", "x_insertWhen", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<input type="hidden" name="z_insertWhen" id="z_insertWhen" value="=">
        ...
        <td<?= $Page->insertWhen->cellAttributes() ?>>
            <div class="text-nowrap">
                <span id="el_cargo_insertWhen" class="ew-search-field">
<input type="<?= $Page->insertWhen->getInputTextType() ?>" name="x_insertWhen" id="x_insertWhen" data-table="cargo" data-field="x_insertWhen" value="<?= $Page->insertWhen->EditValue ?>" placeholder="<?= HtmlEncode($Page->insertWhen->getPlaceHolder()) ?>"<?= $Page->insertWhen->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->insertWhen->getErrorMessage(false) ?></div>
<?php if (!$Page->insertWhen->ReadOnly && !$Page->insertWhen->Disabled && !isset($Page->insertWhen->EditAttrs["readonly"]) && !isset($Page->insertWhen->EditAttrs["disabled"])) { ?>
<script>
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_modifyUserID"<?= $Page->modifyUserID->rowAttributes() ?>>
        <label for="x_modifyUserID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_cargo_modifyUserID"><?= $Page->modifyUserID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_modifyUserID" id="z_modifyUserID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            ...
            <span id="el_cargo_modifyUserID" class="ew-search-field ew-search-field-single">
    <select
        id="x_modifyUserID"
        name="x_modifyUserID"
        class="form-select ew-select<?= $Page->modifyUserID->isInvalidClass() ?>"
        data-select2-id="fcargosearch_x_modifyUserID"
        data-table="cargo"
...
<script>
loadjs.ready("fcargosearch", function() {
    var options = { name: "x_modifyUserID", selectId: "fcargosearch_x_modifyUserID" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcargosearch.lists.modifyUserID.lookupOptions.length) {
        options.data = { id: "x_modifyUserID", form: "fcargosearch" };
    } else {
        options.ajax = { id: "x_modifyUserID", form: "fcargosearch", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
    options = Object.assign({}, ew.selectOptions, options, ew.vars.tables.cargo.fields.modifyUserID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<input type="hidden" name="z_modifyUserID" id="z_modifyUserID" value="=">
        ...
        <td<?= $Page->modifyUserID->cellAttributes() ?>>
            <div class="text-nowrap">
                <span id="el_cargo_modifyUserID" class="ew-search-field">
    <select
        id="x_modifyUserID"
        name="x_modifyUserID"
        class="form-select ew-select<?= $Page->modifyUserID->isInvalidClass() ?>"
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_modifyWhen"<?= $Page->modifyWhen->rowAttributes() ?>>
        <label for="x_modifyWhen" class="<?= $Page->LeftColumnClass ?>"><span id="elh_cargo_modifyWhen"><?= $Page->modifyWhen->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_modifyWhen" id="z_modifyWhen" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            ...
            <span id="el_cargo_modifyWhen" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->modifyWhen->getInputTextType() ?>" name="x_modifyWhen" id="x_modifyWhen" data-table="cargo" data-field="x_modifyWhen" value="<?= $Page->modifyWhen->EditValue ?>" placeholder="<?= HtmlEncode($Page->modifyWhen->getPlaceHolder()) ?>"<?= $Page->modifyWhen->editAttributes() ?>>
...
loadjs.ready(["fcargosearch", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fcargosearch", "x_modifyWhen", jQuery.extend(true, {"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<input type="hidden" name="z_modifyWhen" id="z_modifyWhen" value="=">
        ...
        <td<?= $Page->modifyWhen->cellAttributes() ?>>
            <div class="text-nowrap">
                <span id="el_cargo_modifyWhen" class="ew-search-field">
<input type="<?= $Page->modifyWhen->getInputTextType() ?>" name="x_modifyWhen" id="x_modifyWhen" data-table="cargo" data-field="x_modifyWhen" value="<?= $Page->modifyWhen->EditValue ?>" placeholder="<?= HtmlEncode($Page->modifyWhen->getPlaceHolder()) ?>"<?= $Page->modifyWhen->editAttributes() ?>>
<div class="invalid-feedback"><?= $Page->modifyWhen->getErrorMessage(false) ?></div>
<?php if (!$Page->modifyWhen->ReadOnly && !$Page->modifyWhen->Disabled && !isset($Page->modifyWhen->EditAttrs["readonly"]) && !isset($Page->modifyWhen->EditAttrs["disabled"])) { ?>
<script>
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_core_statusID"<?= $Page->core_statusID->rowAttributes() ?>>
        <label for="x_core_statusID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_cargo_core_statusID"><?= $Page->core_statusID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_core_statusID" id="z_core_statusID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            ...
            <span id="el_cargo_core_statusID" class="ew-search-field ew-search-field-single">
    <select
        id="x_core_statusID"
        name="x_core_statusID"
        class="form-select ew-select<?= $Page->core_statusID->isInvalidClass() ?>"
        data-select2-id="fcargosearch_x_core_statusID"
        data-table="cargo"
...
<script>
loadjs.ready("fcargosearch", function() {
    var options = { name: "x_core_statusID", selectId: "fcargosearch_x_core_statusID" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcargosearch.lists.core_statusID.lookupOptions.length) {
        options.data = { id: "x_core_statusID", form: "fcargosearch" };
    } else {
        options.ajax = { id: "x_core_statusID", form: "fcargosearch", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<input type="hidden" name="z_core_statusID" id="z_core_statusID" value="=">
        ...
        <td<?= $Page->core_statusID->cellAttributes() ?>>
            <div class="text-nowrap">
                <span id="el_cargo_core_statusID" class="ew-search-field">
    <select
        id="x_core_statusID"
        name="x_core_statusID"
        class="form-select ew-select<?= $Page->core_statusID->isInvalidClass() ?>"
...
<?php if ($Page->IsMobileOrModal) { ?>
    <div id="r_core_languageID"<?= $Page->core_languageID->rowAttributes() ?>>
        <label for="x_core_languageID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_cargo_core_languageID"><?= $Page->core_languageID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_core_languageID" id="z_core_languageID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            ...
            <span id="el_cargo_core_languageID" class="ew-search-field ew-search-field-single">
    <select
        id="x_core_languageID"
        name="x_core_languageID"
        class="form-select ew-select<?= $Page->core_languageID->isInvalidClass() ?>"
        data-select2-id="fcargosearch_x_core_languageID"
        data-table="cargo"
...
<script>
loadjs.ready("fcargosearch", function() {
    var options = { name: "x_core_languageID", selectId: "fcargosearch_x_core_languageID" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fcargosearch.lists.core_languageID.lookupOptions.length) {
        options.data = { id: "x_core_languageID", form: "fcargosearch" };
    } else {
        options.ajax = { id: "x_core_languageID", form: "fcargosearch", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<input type="hidden" name="z_core_languageID" id="z_core_languageID" value="LIKE">
        ...
        <td<?= $Page->core_languageID->cellAttributes() ?>>
            <div class="text-nowrap">
                <span id="el_cargo_core_languageID" class="ew-search-field">
    <select
        id="x_core_languageID"
        name="x_core_languageID"
        class="form-select ew-select<?= $Page->core_languageID->isInvalidClass() ?>"
